const {
  ...
  const ownerNumber = ['2250143875869']
...
const sessdata = config.SESSION_ID.replace("YOANN~XMD~", '');
...
const port = process.env.PORT || 9090;
  ...
  console.log('YOANN-XMD CONNECTED SUCCESSFULLY ✅')
...
║ ʏᴏᴜ ᴘʀᴇғɪx : ${prefix}       
║ ʙᴏᴛ ᴍᴏᴅᴇ : ${mode}
║ ᴄʜᴀɴɴᴇʟ : https://whatsapp.com/channel/0029VbB06qE9sBIFlu00Dq0R
╚═══════════════════❒
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴇᴠ ʏᴏᴀɴɴ*`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/mwmtbh.jpg` }, caption: up })
  }
  })
  ...
  try {
    ...
    for (const call of calls) {
      ...
      await conn.sendMessage(from, {
        text: config.REJECT_MSG || '*📞 ᴄᴀʟʟ ɴᴏᴛ ᴀʟʟᴏᴡᴇᴅ ɪɴ ᴛʜɪs ɴᴜᴍʙᴇʀ ʏᴏᴜ ᴅᴏɴᴛ ʜᴀᴠᴇ ᴘᴇʀᴍɪssɪᴏɴ 📵*'
      });
